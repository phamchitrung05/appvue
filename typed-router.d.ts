...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-ecommerce-order-add': RouteRecordInfo<'apps-ecommerce-order-add', '/apps/ecommerce/order/add', Record<never, never>, Record<never, never>>,
    ...
    'apps-ecommerce-product-edit-id': RouteRecordInfo<'apps-ecommerce-product-edit-id', '/apps/ecommerce/product/edit/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'apps-ecommerce-store-add': RouteRecordInfo<'apps-ecommerce-store-add', '/apps/ecommerce/store/add', Record<never, never>, Record<never, never>>,
    'apps-ecommerce-store-list': RouteRecordInfo<'apps-ecommerce-store-list', '/apps/ecommerce/store/list', Record<never, never>, Record<never, never>>,
